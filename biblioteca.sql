...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2021 a las 17:06:57
...
--
-- Estructura de tabla para la tabla `llibreria`
--
...
CREATE TABLE `llibreria` (
  ...
  `Nombre_de_pagines` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `llibreria`
--

INSERT INTO `llibreria` (`Id`, `Titol`, `Autor`, `Any_naixement`, `Any_publicacio`, `Editorial`, `Nombre_de_pagines`) VALUES
...
--
-- Indices de la tabla `llibreria`
--
ALTER TABLE `llibreria`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT de la tabla `llibreria`
--
ALTER TABLE `llibreria`
